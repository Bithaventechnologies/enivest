...
import logo from "../../assets/exodus_dark.png";
...
const ExodusConnector = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 w-full mt-11">
      ...
      {loading && (
        <LoadingModal type={"Exodus"} onClose={() => setLoading(false)} />
      )}
          ...
          <div className=" p-6">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold">Exodus</h2>
              </div>
...
export default ExodusConnector;
