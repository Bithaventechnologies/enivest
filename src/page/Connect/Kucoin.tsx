...
import logo from "../../assets/kucoin_dark.png";
...
const KucoinConnector = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 w-full mt-11">
      ...
      {loading && (
        <LoadingModal type={"Kucoin"} onClose={() => setLoading(false)} />
      )}
          ...
          <div className=" p-6">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold">Kucoin</h2>
              </div>
