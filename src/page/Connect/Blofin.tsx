...
import logo from "../../assets/blofin_dark.png";
...
const BlofinConnector = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 w-full mt-11">
      ...
      {loading && (
        <LoadingModal type={"Blofin"} onClose={() => setLoading(false)} />
      )}
          ...
          <div className=" p-6">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold">Blofin</h2>
              </div>
...
export default BlofinConnector;
